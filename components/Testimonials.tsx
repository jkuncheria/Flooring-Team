      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Don't just take our word for it. See what real customers have to say about their Flooring Team experience.
          </p>
        </div>
        ...
        <div 
          ref={widgetRef}
          className="elfsight-app-ff37842a-6d98-40fb-9288-f340a595a772" 
