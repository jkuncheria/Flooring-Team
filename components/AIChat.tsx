...
const AIChat: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { id: 'welcome', role: 'model', text: 'Hi there! I\'m your Flooring Team Smart Assistant. We\'re here to help you find the perfect flooring for your home. Looking for hardwood, carpet, tile, or something else? Ask me anything!' }
  ]);
